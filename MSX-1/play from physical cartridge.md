...
```
Sakhr MSX Story Demo.rom        (128 KB)
```
...
- **An EPROM or flash chip of at least 128 KB** for the ROM. Common
  parts: `M27C1001` (UV-EPROM) or `AT29C010` (flash EEPROM).
...
- **Press the Space bar** to walk through three biographical / story
