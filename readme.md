...
> through four story slides — Mohammed Al-Sharekh, Nabil Ali, the
> Sakhr Computer project, and the Sakhr AX-100 (1984) — with PSG
> background music, animated splash screen, typewriter body text, and
> MSX keyclick sound. More slides, finer art, and possibly an MSX2
> high-resolution version are planned.
...
```
MSX-1/
├─ Sakhr MSX Story Demo.rom         ← cartridge image (160 KB)
...
- Letter-by-letter typewriter body text with MSX-style keyclicks at
  word boundaries.
- Looping back to the splash screen at the end of slide 4.

## Status

Demo / proof-of-concept. Works end-to-end and is enjoyable to watch,
but the content is intentionally compact — four slides — so people
